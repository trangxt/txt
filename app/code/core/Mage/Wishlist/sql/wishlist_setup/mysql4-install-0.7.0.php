...
CREATE TABLE IF NOT EXISTS {$this->getTable('wishlist')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('wishlist_item')} (
  ...
  KEY `FK_WISHLIST_STORE` (`store_id`),    CONSTRAINT `{$table_prefix}FK_ITEM_WISHLIST` FOREIGN KEY (`wishlist_id`) REFERENCES {$this->getTable('wishlist')} (`wishlist_id`) ON DELETE CASCADE ON UPDATE CASCADE
