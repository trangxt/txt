...
//-------
$installer->run("
    CREATE TABLE IF NOT EXISTS `{$billingAgreementTable}` (
...
$installer->getConnection()->addConstraint(
    $table_prefix.'FK_BILLING_AGREEMENT_CUSTOMER',
...
//-------
$installer->run("
    CREATE TABLE IF NOT EXISTS `{$billingAgreementOrderTable}` (
...
$installer->getConnection()->addConstraint(
    $table_prefix.'FK_BILLING_AGREEMENT_ORDER_AGREEMENT',
...
$installer->getConnection()->addConstraint(
    $table_prefix.'FK_BILLING_AGREEMENT_ORDER_ORDER',
    $billingAgreementOrderTable,
    'order_id',
    $orderTable,
    'entity_id'
...
$this->getConnection()->addConstraint($table_prefix.'FK_RECURRING_PROFILE_CUSTOMER', $profileTable, 'customer_id',
    $customerEntityTable, 'entity_id', 'SET NULL'
);

$this->getConnection()->addConstraint($table_prefix.'FK_RECURRING_PROFILE_STORE', $profileTable, 'store_id',
    $coreStoreTable, 'store_id', 'SET NULL'
);

$this->run("
CREATE TABLE IF NOT EXISTS `{$profileOrderTable}` (
...
$this->getConnection()->addConstraint($table_prefix.'FK_RECURRING_PROFILE_ORDER_PROFILE', $profileOrderTable, 'profile_id',
    $profileTable, 'profile_id'
);

$this->getConnection()->addConstraint($table_prefix.'FK_RECURRING_PROFILE_ORDER_ORDER', $profileOrderTable, 'order_id',
