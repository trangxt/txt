...
$installer->run("
	DROP TABLE IF EXISTS `{$tablePaymentTransaction}`;
CREATE TABLE IF NOT EXISTS `{$tablePaymentTransaction}` (
...
$installer->getConnection()->addConstraint(
    $table_prefix.'SALES_PAYMENT_TRANSACTION_PARENT',
...
$installer->getConnection()->addConstraint(
    $table_prefix.'SALES_PAYMENT_TRANSACTION_ORDER',
    $tablePaymentTransaction,
    'order_id',
    $tableOrders,
    'entity_id'
...
$installer->getConnection()->addConstraint(
    $table_prefix.'SALES_PAYMENT_TRANSACTION_PAYMENT',
    $tablePaymentTransaction,
    'payment_id',
    $tableOrderPayment,
    'entity_id'
