...
$installer->run("
	DROP TABLE IF EXISTS `{$installer->getTable('sales/invoiced_aggregated')}`;
	...
	DROP TABLE IF EXISTS `{$installer->getTable('sales/invoiced_aggregated_order')}`;
...
$installer->getConnection()->addConstraint(
    $table_prefix.'SALES_INVOICED_AGGREGATED_STORE',
...
$installer->getConnection()->addConstraint(
    $table_prefix.'SALES_INVOICED_AGGREGATED_ORDER_STORE',
