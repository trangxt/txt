...
$installer->run("
	DROP TABLE IF EXISTS `{$installer->getTable('sales/shipping_aggregated')}`;
	...
	DROP TABLE IF EXISTS `{$installer->getTable('sales/shipping_aggregated_order')}`;
...
$installer->getConnection()->addConstraint(
    $table_prefix.'SALES_SHIPPING_AGGREGATED_STORE',
...
$installer->getConnection()->addConstraint(
    $table_prefix.'SALES_SHIPPING_AGGREGATED_ORDER_STORE',
