...
CREATE TABLE `{$statusStateTable}` (
  ...
  CONSTRAINT `{$table_prefix}FK_SALES_ORDER_STATUS_STATE_STATUS` FOREIGN KEY (`status`)
...
CREATE TABLE `{$statusLabelTable}` (
  ...
  KEY `{$table_prefix}FK_SALES_ORDER_STATUS_LABEL_STORE` (`store_id`),
  CONSTRAINT `{$table_prefix}FK_SALES_ORDER_STATUS_LABEL_STATUS` FOREIGN KEY (`status`)
    REFERENCES `{$statusTable}` (`status`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `{$table_prefix}FK_SALES_ORDER_STATUS_LABEL_STORE` FOREIGN KEY (`store_id`)
