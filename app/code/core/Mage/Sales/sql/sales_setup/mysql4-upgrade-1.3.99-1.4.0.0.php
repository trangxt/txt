...
$installer->getConnection()->addConstraint($table_prefix.'FK_SALES_QUOTE_ITEM_STORE',
...
$installer->getConnection()->addConstraint($table_prefix.'FK_SALES_ORDER_ITEM_STORE',
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_order_grid')}`;
...
DROP TABLE IF EXISTS  `{$installer->getTable('sales_flat_order_status_history')}` ;
...
DROP TABLE IF EXISTS  `{$installer->getTable('sales_flat_order_payment')}`;
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_shipment')}`;
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_shipment_grid')}`;
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_shipment_item')}`;
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_shipment_track')}`;
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_shipment_comment')}`;
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_invoice')}`;
...
/* Invoices Grid */
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_invoice_grid')}`;
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_invoice_item')}` ;
...
/* Invoice Comments */
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_invoice_comment')}` ;
...
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_creditmemo')}` ;
...
/* CreditMemo Grid */
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_creditmemo_grid')}` ;
...
/* CreditMemo Item */
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_creditmemo_item')}` ;
...
/* CreditMemo Comment */
DROP TABLE IF EXISTS `{$installer->getTable('sales_flat_creditmemo_comment')}` ;
...
foreach ($constraints as $table => $list) {
    foreach ($list as $code => $constraint) {
        ...
        array_unshift($constraint, strtoupper($table_prefix."_".$table . '_' . $code));		
