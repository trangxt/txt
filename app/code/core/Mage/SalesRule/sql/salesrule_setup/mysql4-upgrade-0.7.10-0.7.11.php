...
$installer->getConnection()->addConstraint($table_prefix.'FK_SALESTRULE_COUPON_AGGREGATED_ORDER_STORE',
...
$installer->getConnection()->addConstraint($table_prefix.'FK_SALESTRULE_COUPON_AGGREGATED_STORE',
