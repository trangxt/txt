...
DROP TABLE IF EXISTS `{$installer->getTable('cataloginventory/stock_status_indexer_idx')}`;

CREATE TABLE IF NOT EXISTS `{$installer->getTable('cataloginventory/stock_status_indexer_idx')}` (
...
DROP TABLE IF EXISTS `{$installer->getTable('cataloginventory/stock_status_indexer_tmp')}`;
