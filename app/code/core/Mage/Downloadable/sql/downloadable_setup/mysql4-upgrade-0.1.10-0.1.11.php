...
$installer->run("
CREATE TABLE IF NOT EXISTS `{$installer->getTable('downloadable/link_purchased_item')}`(
...
$conn->addConstraint($table_prefix.'FK_DOWNLOADABLE_LINK_PURCHASED_ID', $installer->getTable('downloadable/link_purchased_item'), 'purchased_id', $installer->getTable('downloadable/link_purchased'), 'purchased_id'
);
$conn->addConstraint($table_prefix.'FK_DOWNLOADABLE_ORDER_ITEM_ID', $installer->getTable('downloadable/link_purchased_item'), 'order_item_id', $installer->getTable('sales/order_item'), 'item_id'
);
