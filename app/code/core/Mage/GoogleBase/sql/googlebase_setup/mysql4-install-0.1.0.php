...
CREATE TABLE IF NOT EXISTS {$this->getTable('googlebase/types')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('googlebase/items')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('googlebase/attributes')} (
