...
$installer = $this;
$installer->run("
CREATE TABLE IF NOT EXISTS {$this->getTable('bundle/selection_price')} (
...
$installer->getConnection()->addConstraint(
    $table_prefix.'FK_BUNDLE_PRICE_SELECTION_ID',
...
$installer->getConnection()->addConstraint(
    $table_prefix.'FK_BUNDLE_PRICE_SELECTION_WEBSITE',
    $this->getTable('bundle/selection_price'),
    'website_id',
