...
CREATE TABLE IF NOT EXISTS {$this->getTable('newsletter_problem')} (
  ...
  KEY `FK_PROBLEM_QUEUE` (`queue_id`),    CONSTRAINT `{$table_prefix}FK_PROBLEM_QUEUE` FOREIGN KEY (`queue_id`) REFERENCES {$this->getTable('newsletter_queue')} (`queue_id`),    CONSTRAINT `{$table_prefix}FK_PROBLEM_SUBSCRIBER` FOREIGN KEY (`subscriber_id`) REFERENCES {$this->getTable('newsletter_subscriber')} (`subscriber_id`)
...
CREATE TABLE IF NOT EXISTS {$this->getTable('newsletter_queue')} (
  ...
  KEY `FK_QUEUE_TEMPLATE` (`template_id`),    CONSTRAINT `{$table_prefix}FK_QUEUE_TEMPLATE` FOREIGN KEY (`template_id`) REFERENCES {$this->getTable('newsletter_template')} (`template_id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS {$this->getTable('newsletter_queue_link')} (
  ...
  KEY `FK_QUEUE_LINK_QUEUE` (`queue_id`),    CONSTRAINT `{$table_prefix}FK_QUEUE_LINK_QUEUE` FOREIGN KEY (`queue_id`) REFERENCES {$this->getTable('newsletter_queue')} (`queue_id`) ON DELETE CASCADE,    CONSTRAINT `{$table_prefix}FK_QUEUE_LINK_SUBSCRIBER` FOREIGN KEY (`subscriber_id`) REFERENCES {$this->getTable('newsletter_subscriber')} (`subscriber_id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS {$this->getTable('newsletter_queue_store_link')} (
  `queue_id` int(7) unsigned NOT NULL default '0',
  `store_id` smallint(5) unsigned NOT NULL default '0',
  PRIMARY KEY  (`queue_id`,`store_id`),    CONSTRAINT `{$table_prefix}FK_LINK_QUEUE` FOREIGN KEY (`queue_id`) REFERENCES {$this->getTable('newsletter_queue')} (`queue_id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS {$this->getTable('newsletter_subscriber')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('newsletter_template')} (
