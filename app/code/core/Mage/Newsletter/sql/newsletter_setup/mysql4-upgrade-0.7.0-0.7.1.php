...
ALTER TABLE {$this->getTable('newsletter_queue_store_link')}
    ADD    CONSTRAINT `{$table_prefix}FK_NEWSLETTER_QUEUE_STORE_LINK_STORE` FOREIGN KEY (`store_id`)
...
ALTER TABLE {$this->getTable('newsletter_subscriber')}
    ADD    CONSTRAINT `{$table_prefix}FK_NEWSLETTER_SUBSCRIBER_STORE` FOREIGN KEY (`store_id`)
    REFERENCES {$this->getTable('core_store')} (`store_id`)
        ON UPDATE CASCADE
        ON DELETE SET NULL;
");
