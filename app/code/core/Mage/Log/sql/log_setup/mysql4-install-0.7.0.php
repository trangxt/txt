...
CREATE TABLE IF NOT EXISTS {$this->getTable('log_customer')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('log_quote')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('log_summary')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('log_summary_type')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('log_url')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('log_url_info')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('log_visitor')} (
...
CREATE TABLE IF NOT EXISTS {$this->getTable('log_visitor_info')} (
