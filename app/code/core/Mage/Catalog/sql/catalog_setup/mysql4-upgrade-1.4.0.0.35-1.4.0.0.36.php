...
$installer->getConnection()->dropForeignKey(
    ...
    $table_prefix.'FK_CATALOG_PRODUCT_SUPER_ATTRIBUTE_LABEL_ATTRIBUTE'
);
$installer->getConnection()->dropForeignKey(
    $installer->getTable('catalog/product_super_attribute_label'),
    $table_prefix.'FK_CATALOG_PRODUCT_SUPER_ATTRIBUTE_LABEL_STORE'
);
$installer->getConnection()->addConstraint($table_prefix.'FK_CATALOG_PROD_SUPER_ATTR_LABEL_ATTR',
...
$installer->getConnection()->addConstraint($table_prefix.'FK_CATALOG_PROD_SUPER_ATTR_LABEL_STORE',
