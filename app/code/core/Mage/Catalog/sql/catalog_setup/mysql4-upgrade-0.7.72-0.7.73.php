...
$installer->getConnection()->addConstraint($table_prefix.'FK_CATALOG_PRODUCT_SUPER_ATTRIBUTE_LABEL_ATTRIBUTE',
...
$installer->getConnection()->addConstraint($table_prefix.'FK_CATALOG_PRODUCT_SUPER_ATTRIBUTE_LABEL_STORE',
